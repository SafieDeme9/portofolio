        ...
        <div className="p-6 text-center sm:p-7 md:p-6 xl:p-7">
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {Project.tech && Project.tech.map((tech: string, index: number) => (
                <div 
                  key={index} 
                  className="flex items-center gap-1 px-3 py-1.5 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200"
                  title={tech}
                >
          ...
          <div className="flex justify-center gap-4">
            <a
              ...
              className="flex items-center gap-2 rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 transition 
